...
const Post = ({post,setCurrentId}) => {
  ...
  <Card className={classes.card}>
    ...
    <Typography variant="body2" color="textSecondary" component="h2">{post.tags.map((t) => `#${t} `)}{/*add map here later*/}</Typography>
    </div>
    ...
    <CardActions className={classes.cardActions}>
      <Button size="small" color="primary" onClick={()=> {dispatch(likePost(post._id))}}>
        <ThumbUpAltIcon fontSize="small"></ThumbUpAltIcon> &nbsp; Like &nbsp;{post.likeCount}
      </Button>
